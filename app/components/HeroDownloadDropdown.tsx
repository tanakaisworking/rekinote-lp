...
export function HeroDownloadDropdown({
  ...
  const handleDownload = (url: string) => {
    ...
    setTimeout(() => {
      window.location.href = `/${resolvedLang}/thanks/`;
    }, 5000);
  };
        ...
        <div className="absolute left-0 top-full mt-2 w-64 rounded-xl border border-white/10 bg-[#1a1a22]/95 shadow-xl shadow-black/30 backdrop-blur-xl overflow-hidden z-50">
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-white/50">{resolvedLang === "ja" ? "Apple Silicon（M1以降）" : "Apple Silicon (M1+)"}</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div>
                ...
                <div className="text-xs text-white/50">{resolvedLang === "ja" ? "Windows 10以降" : "Windows 10+"}</div>
              </div>
