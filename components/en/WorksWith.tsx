...
const apps: App[] = [
  ...
  { name: "In-person",            node: MessagesSquareIcon },
  { name: "Other Call Services",  fallback: "…" },
];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl md:text-[40px] font-bold tracking-tight leading-[1.3]">
              For every call,<br className="hidden md:block" />on your usual device.
            </h2>
            <p className="mt-6 muted leading-[1.95] max-w-[440px]">
              Since it captures audio at the OS level, just install and launch it. It catches every conversation across any service you use.
            </p>
          </div>
