    ...
    <div className="card p-6 flex flex-col gap-4 flex-1">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-[14px] font-semibold mt-0.5">Audio Transcription</div>
        </div>
      </div>
      <div className="bg-[#0c0c10] rounded-xl p-4 space-y-3 text-[12.5px] leading-[1.75] border border-line">
        <div className="flex gap-2.5">
          ...
          <p className="text-[#ececef]/80"><span className="text-[#a78bfa] font-medium">Tanaka:</span> Sales exceeded last month. What do you think is the main reason?</p>
        </div>
        <div className="flex gap-2.5">
          <span className="font-mono-num text-[#5e5e6a] shrink-0 mt-px">00:18</span>
          <p className="text-[#ececef]/80"><span className="text-[#7c9cf0] font-medium">Matsushima:</span> The main factor is the improved conversion rate of the new channel—</p>
        </div>
        <div className="flex gap-2.5">
          <span className="font-mono-num text-[#5e5e6a] shrink-0 mt-px">00:34</span>
          <p className="text-[#ececef]/80"><span className="text-[#a78bfa] font-medium">Tanaka:</span> Please share the specific numbers by next time.</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="card p-6 flex flex-col gap-4 flex-1">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-[14px] font-semibold mt-0.5">Calendar Information</div>
        </div>
      </div>
      <div className="bg-[#0c0c10] rounded-xl p-4 border border-line flex flex-col gap-3">
        <div className="flex items-center gap-2 pb-3 border-b border-line">
          ...
          <span className="text-[13px] font-semibold">Weekly Sync</span>
        </div>
        <div className="space-y-2.5 text-[12.5px]">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-[#ececef]/90">Tanaka, Matsushima, Sato</span>
          </div>
          <div className="flex justify-between">
        ...
        <p className="text-[11.5px] muted leading-[1.7] pt-1 border-t border-line">
          Automatically links &quot;who, when, what&quot; to the audio
        </p>
      </div>
    </div>
  );
      ...
      <div className="relative">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <div className="text-[18px] font-bold mt-0.5">Knowledge Database</div>
          </div>
        </div>
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { title: "Full-text Search", body: "Search across participants, dates, and meeting contents." },
            { title: "AI Q&A", body: "Ask 'What were last week's decisions?' in natural language." },
            { title: "Accumulated Assets", body: "The more you use it, the deeper the context. Your own second brain." },
          ].map((f) => (
      ...
      <div className="container-x relative">
        <div className="text-center mb-16">
          ...
          <h2 className="mt-4 text-3xl md:text-[42px] font-bold tracking-tight leading-tight">
            Simple, <span className="gradient-text">yet powerful.</span>
          </h2>
        </div>
