      ...
      <div className="container-x relative z-10 px-6 pt-20 pb-12 md:pt-28 md:pb-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="mt-9">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-x-7 gap-y-3 items-center text-[13px]">
              <span className="flex items-center gap-2 text-[#ececef]/90">
                ...
                <span>Mac <span className="muted">先行配信中</span></span>
              </span>
              <span className="flex items-center gap-2 dim">
                ...
                <span>Win <span className="dim">リリース準備中</span></span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -inset-12 pointer-events-none"
               style={{ background: "radial-gradient(circle at 60% 50%, rgba(139,92,246,0.18), transparent 65%)" }} />
          <div className="rounded-2xl overflow-hidden border border-line-strong bg-surface relative shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)]">
            <Image
