        ...
        <div className="max-w-[640px]">
          ...
          <div className="mt-9">
            <div className="flex flex-wrap items-center gap-3">
              <a href="#download" className="btn-primary">{dict.waitlist}</a>
            ...
            <div className="mt-6 flex flex-wrap gap-x-7 gap-y-3 items-center text-[13px]">
              <span className="flex items-center gap-2 text-[#ececef]/90">
                ...
                <span>{dict.mac} <span className="muted">{dict.macSub}</span></span>
              </span>
              <span className="flex items-center gap-2 dim">
                ...
                <span>{dict.win} <span className="dim">{dict.winSub}</span></span>
              </span>
            </div>
          </div>
        </div>
